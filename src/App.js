...
import LogoutComponent from "./feature/Authentication/LogoutUser";
...
import { getStorage, clearStorage } from "./share/api/helpers";
  ...
  render() {
    return (
      <Routes>
        ...
        <Route exact path="logout" element={<LayoutDashboard />}>
          <Route exact index element={<LogoutComponent />} />
        </Route>
